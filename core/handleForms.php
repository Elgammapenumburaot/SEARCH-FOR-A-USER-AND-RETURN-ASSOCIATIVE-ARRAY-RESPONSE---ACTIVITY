...
if (isset($_POST['insertUserBtn'])) {
    ...
    if (!empty($first_name) && !empty($last_name) && !empty($email) && !empty($years_of_experience) && !empty($specialization) ){
        $insertUser = insertNewUser($pdo,$_POST['first_name'], $_POST['last_name'], $_POST['email'], $_POST['years_of_experience'], $_POST['specialization'], $_POST['favorite_ward']);
...
if (isset($_POST['editUserBtn'])) {
	...
	$editUser = editUser($pdo,$_POST['first_name'], $_POST['last_name'], $_POST['email'], $_POST['years_of_experience'], $_POST['specialization'], $_POST['favorite_ward'], $_GET['id']);
